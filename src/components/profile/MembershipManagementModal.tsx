          ...
          <ScrollView className="flex-1 bg-background">
            ...
            <View className="flex-1 items-center justify-center p-6">
              ...
              <Text className="text-textSecondary text-center mb-8 leading-relaxed">
                Upptäck våra flexibla medlemskapsplaner och börja träna på Stockholms bästa anläggningar redan idag.
              </Text>
              <TouchableOpacity
      ...
      <SafeAreaWrapper>
        ...
        <ScrollView className="flex-1 bg-background" showsVerticalScrollIndicator={false}>
            ...
            <View className="bg-gradient-to-br from-primary via-purple-600 to-pink-500 rounded-3xl p-6 mb-6">
              <View className="flex-row items-center justify-between mb-4">
                ...
                <View className="bg-white/20 rounded-full px-3 py-1.5">
                  <Text className="text-white text-xs font-bold">AKTIV</Text>
                </View>
              </View>
          ...
          <View className="mx-4 mb-6">
            <Text className="text-textPrimary text-lg font-bold mb-4">Snabbåtgärder</Text>
          ...
          {subscription && (
            <View className="mx-4 mb-6">
              <Text className="text-textPrimary text-lg font-bold mb-4">Prenumerationsdetaljer</Text>
              ...
              <View className="bg-surface rounded-2xl p-4">
                ...
                {subscription.current_period_end && (
                  <View className="flex-row items-center justify-between mb-3">
                    <Text className="text-textSecondary">Nästa fakturering</Text>
                ...
                <View className="flex-row items-center justify-between">
                  ...
                  <Text className="text-textPrimary font-medium">Automatisk</Text>
                </View>
              </View>
            </View>
          )}
          ...
          {/* Progress Insights */}
          <View className="mx-4 mb-6">
            <Text className="text-textPrimary text-lg font-bold mb-4">Månadsöversikt</Text>
            
            <View className="bg-surface rounded-2xl p-4">
              <View className="flex-row items-center justify-between mb-3">
                <Text className="text-textSecondary">Förbrukning denna månad</Text>
                <Text className="text-textPrimary font-bold">{usagePercentage}%</Text>
              </View>
              ...
              <View className="flex-row justify-between">
                ...
                <View className="items-center">
                  <Text className="text-primary text-lg font-bold">{creditsRemaining}</Text>
                  <Text className="text-textSecondary text-xs">Återstående</Text>
                </View>
                <View className="items-center">
                  <Text className="text-textPrimary text-lg font-bold">{membership.credits}</Text>
          ...
          <View className="mx-4 mb-8">
            <Text className="text-textPrimary text-lg font-bold mb-4">Kontoinställningar</Text>
              ...
              {[
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    Alert.alert(
                      item.title,
                      `Är du säker på att du vill ${item.action === 'pause-membership' ? 'pausa' : 'avsluta'} ditt medlemskap?`,
                      [
                        { text: 'Avbryt', style: 'cancel' },
                        { 
                          text: 'Fortsätt', 
                          style: item.action === 'cancel-membership' ? 'destructive' : 'default',
