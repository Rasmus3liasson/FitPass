...
const PAUSE_REASONS: Reason[] = [
  {
    id: 'vacation',
    label: 'På semester/resa',
    value: 'vacation',
    analytics_key: 'pause_vacation',
    icon: AirplaneTilt,
  },
  {
    id: 'injury',
...
const CANCEL_REASONS: Reason[] = [
  {
    ...
    label: 'För dyrt',
    value: 'expensive',
    analytics_key: 'cancel_expensive',
    icon: CurrencyDollar,
  },
  {
    id: 'not_using',
    label: 'Använder inte tillräckligt',
    value: 'not_using',
    analytics_key: 'cancel_not_using',
    icon: TrendDown,
  },
  {
    id: 'switching',
    label: 'Byter till annat gym',
    value: 'switching',
    analytics_key: 'cancel_switching',
    icon: Swap,
  },
  {
    id: 'dissatisfied',
    label: 'Missnöjd med tjänsten',
    value: 'dissatisfied',
    analytics_key: 'cancel_dissatisfied',
    icon: ThumbsDown,
  },
  {
    id: 'other',
