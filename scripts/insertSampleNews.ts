...
const sampleNewsData = [
  {
    ...
    description:
      'Join our high-intensity interval training sessions every Monday and Wednesday at 7 PM. Perfect for burning calories and building strength.',
    content:
      "We're excited to announce brand new HIIT classes starting this week! These sessions are designed to maximize your workout efficiency with short bursts of high-intensity exercises followed by brief recovery periods. Whether you're a beginner or advanced athlete, our certified instructors will guide you through modifications to suit your fitness level. Come ready to sweat and have fun!",
    type: 'new_class',
    club_id: CLUB_ID,
    image_url:
  ...
  },
  {
    ...
    description:
      'Book personal training sessions this month and save 20%! Work one-on-one with our certified trainers to reach your fitness goals faster.',
    content:
      "This month only, we're offering an exclusive 20% discount on all personal training packages. Whether you're just starting your fitness journey or looking to break through a plateau, our certified personal trainers are here to help. Each session includes: Personalized workout plans, Nutrition guidance, Form correction and injury prevention, Progress tracking and goal setting. Don't miss this opportunity to invest in yourself and accelerate your results!",
    type: 'promotion',
    club_id: CLUB_ID,
    image_url:
      'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=800&q=80',
...
async function insertSampleNews() {
  ...
  try {
    ...
    const { data, error } = await supabase.from('news').insert(sampleNewsData).select();
