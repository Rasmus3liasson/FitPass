    ...
    <SafeAreaWrapper>
      ...
      <View className="flex-1 bg-background">
        ...
        <ScrollView className="flex-1 px-4 py-6">
          <View className="mb-6">
            <Text className="text-textPrimary text-xl font-bold mb-2">Ange din standardplats</Text>
            <Text className="text-textSecondary text-base">
              Denna plats kommer att användas för att beräkna avstånd till gym när platstjänster är
              inaktiverade eller otillgängliga.
            </Text>
          </View>
          ...
          >
            <Text className="text-textPrimary text-base font-semibold">Spara plats</Text>
          </TouchableOpacity>

          {/* Info Section */}
          <View className="bg-surface rounded-2xl p-4 mt-6">
            <Text className="text-textPrimary text-base font-medium mb-2">Om platstjänster</Text>
            <Text className="text-textSecondary text-sm leading-relaxed">
              {process.env.EXPO_PUBLIC_APP_NAME} använder din plats för att visa korrekta avstånd
              till gym och träningscentrum. Du kan inaktivera platstjänster i
              huvudprofilinställningarna och använda din standardplats istället. Din platsdata
              används endast för avståndberäkningar och delas aldrig med tredje part.
            </Text>
          </View>
        </ScrollView>
      </View>
