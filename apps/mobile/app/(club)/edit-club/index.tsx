...
export default function EditClubScreen() {
  ...
  const { form, handleChange, updateFormFromClub, checkForTempOpeningHours, formatOpeningHours } =
    useClubForm(club);
    ...
    <DataGuard isLoading={isLoading} data={user}>
      <SafeAreaWrapper>
        ...
        >
          ...
          <Section title="Företagsinformation" description="Organisationsdetaljer och prissättning">
          ...
          {/* Operating Hours */}
          <Section title="Öppettider" description="Ställ in när din klubb är öppen för medlemmar">
          ...
          <Section title="Kontosäkerhet" description="Hantera dina kontoinställningar och säkerhet">
            <View className="bg-surface rounded-2xl p-4 mb-4">
              <TouchableOpacity
